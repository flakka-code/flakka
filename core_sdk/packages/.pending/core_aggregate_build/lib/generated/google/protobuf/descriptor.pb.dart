...
//  source: google/protobuf/descriptor.protos
//
// @dart = 2.12
...
/// The protocol compiler can output a FileDescriptorSet containing the .protos
/// files it parses.
...
/// Describes a complete .protos file.
class FileDescriptorProto extends $pb.GeneratedMessage {
  ...
  /// The edition of the protos file.
  @$pb.TagNumber(14)
...
class FieldDescriptorProto extends $pb.GeneratedMessage {
  ...
  ///  This can be useful for round-tripping the .protos file. For consistency we
...
class FileOptions extends $pb.GeneratedMessage {
  ...
  /// Sets the Java package where classes generated from this .protos will be
  /// placed.  By default, the protos package is used, but this is often
  /// inappropriate because protos packages do not normally start with backwards
  /// domain names.
  @$pb.TagNumber(1)
  ...
  /// Controls the name of the wrapper Java class generated for the .protos file.
  /// That class will always contain the .protos file's getDescriptor() method as
  /// well as any top-level extensions defined in the .protos file.
  /// If java_multiple_files is disabled, then all the other classes from the
  /// .protos file will be nested inside the single wrapper outer class.
  @$pb.TagNumber(8)
  ...
  /// file for each top-level message, enum, and service defined in the .protos
  ...
  /// Sets the Go package where structs generated from this .protos will be
  /// placed. If omitted, the Go package will be derived from the following:
  ///   - The basename of the package import path, if provided.
  ///   - Otherwise, the package statement in the .protos file, if present.
  ///   - Otherwise, the basename of the .protos file, without extension.
  @$pb.TagNumber(11)
  ...
  /// Enables the use of arenas for the protos messages in this file. This applies
  ...
  /// generated classes from this .protos. There is no default.
  @$pb.TagNumber(36)
  ...
  /// By default Swift generators will take the protos package and CamelCase it
  ...
  /// from this .protos. Default is empty.
  @$pb.TagNumber(40)
  ...
  /// Default is empty. When this option is empty, the protos file name will be
...
class MessageOptions extends $pb.GeneratedMessage {
  ...
  ///  NOTE: Do not set the option in .protos files. Always use the maps syntax
  ///  instead. The option should only be implicitly set by the protos compiler
  ///  parser.
  ///
...
/// extension (denoted with parentheses in options specs in .protos files).
...
/// for the closest matching edition, followed by protos merges.
...
class SourceCodeInfo extends $pb.GeneratedMessage {
  ...
  ///  A Location identifies a piece of source code in a .protos file which
...
class GeneratedCodeInfo_Annotation extends $pb.GeneratedMessage {
  ...
  /// Identifies the element in the original source .protos file. This field
  /// is formatted the same as SourceCodeInfo.Location.path.
  @$pb.TagNumber(1)
  $core.List<$core.int> get path => $_getList(0);

  /// Identifies the filesystem path to the original source .protos.
  @$pb.TagNumber(2)
...
/// source file, but may contain references to different source .protos files.
