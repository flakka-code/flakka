...
//  source: google/protobuf/type.protos
//
// @dart = 2.12
...
class Enum extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Enum', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.protobuf'), createEmptyInstance: create)
    ...
    ..aOM<$1.SourceContext>(4, _omitFieldNames ? '' : 'sourceContext', subBuilder: $1.SourceContext.create)
...
class Option extends $pb.GeneratedMessage {
  ...
  /// descriptor.protos), this is the short name. For example, `"map_entry"`.
  ...
  /// the corresponding wrapper type defined in google/protobuf/wrappers.protos
