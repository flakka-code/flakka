...
//  source: google/protobuf/compiler/plugin.protos
//
// @dart = 2.12
...
class CodeGeneratorResponse_Feature extends $pb.ProtobufEnum {
  ...
  static CodeGeneratorResponse_Feature? valueOf($core.int value) => _byValue[value];

  const CodeGeneratorResponse_Feature._($core.int v, $core.String n) : super(v, n);
}
