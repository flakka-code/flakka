...
class _$ParsedPackageSet extends ParsedPackageSet {
  factory _$ParsedPackageSet(
          [void Function(ParsedPackageSetBuilder)? updates]) =>
      (new ParsedPackageSetBuilder()..update(updates))._build();

  _$ParsedPackageSet._() : super._();

  @override
  ParsedPackageSet rebuild(void Function(ParsedPackageSetBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ParsedPackageSetBuilder toBuilder() =>
      new ParsedPackageSetBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ParsedPackageSet;
  }
  ...
  @override
  String toString() {
    return newBuiltValueToStringHelper(r'ParsedPackageSet').toString();
  }
}

class ParsedPackageSetBuilder
    implements Builder<ParsedPackageSet, ParsedPackageSetBuilder> {
  _$ParsedPackageSet? _$v;

  ParsedPackageSetBuilder();

  @override
  void replace(ParsedPackageSet other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$ParsedPackageSet;
  }

  @override
  void update(void Function(ParsedPackageSetBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  ParsedPackageSet build() => _build();

  _$ParsedPackageSet _build() {
    final _$result = _$v ?? new _$ParsedPackageSet._();
    replace(_$result);
    return _$result;
  }
}
