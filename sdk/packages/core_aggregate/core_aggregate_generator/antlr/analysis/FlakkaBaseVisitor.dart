...
class FlakkaBaseVisitor<T> extends ParseTreeVisitor<T> implements FlakkaVisitor<T> {
  ...
  /// [visitChildren] on [ctx].
  @override
  T? visitCodeGeneratorRequestBody(CodeGeneratorRequestBodyContext ctx) => visitChildren(ctx);
  /// The default implementation returns the result of calling
  /// [visitChildren] on [ctx].
  @override
  T? visitCodeGeneratorRequestHead(CodeGeneratorRequestHeadContext ctx) => visitChildren(ctx);
  /// The default implementation returns the result of calling
  /// [visitChildren] on [ctx].
  @override
