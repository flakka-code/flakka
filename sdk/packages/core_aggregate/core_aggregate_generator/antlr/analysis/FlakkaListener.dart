...
abstract class FlakkaListener extends ParseTreeListener {
  ...
  /// Enter a parse tree produced by [FlakkaParser.codeGeneratorRequestBody].
  /// [ctx] the parse tree
  void enterCodeGeneratorRequestBody(CodeGeneratorRequestBodyContext ctx);
  /// Exit a parse tree produced by [FlakkaParser.codeGeneratorRequestBody].
  /// [ctx] the parse tree
  void exitCodeGeneratorRequestBody(CodeGeneratorRequestBodyContext ctx);

  /// Enter a parse tree produced by [FlakkaParser.codeGeneratorRequestHead].
  /// [ctx] the parse tree
  void enterCodeGeneratorRequestHead(CodeGeneratorRequestHeadContext ctx);
  /// Exit a parse tree produced by [FlakkaParser.codeGeneratorRequestHead].
  /// [ctx] the parse tree
  void exitCodeGeneratorRequestHead(CodeGeneratorRequestHeadContext ctx);
