...
codeGeneratorRequest: codeGeneratorRequestHead codeGeneratorRequestBody EOF;

codeGeneratorRequestBody : allFileDescriptors sourceFileDescriptors ;

codeGeneratorRequestHead : CODE_GENERATOR_REQUEST ;
