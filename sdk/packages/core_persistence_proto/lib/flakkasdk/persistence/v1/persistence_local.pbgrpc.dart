...
@$pb.GrpcServiceName('flakkasdk.persistence.v1.PersistenceLocal')
class PersistenceLocalClient extends $grpc.Client {
  static final _$persist = $grpc.ClientMethod<$0.PersistRequest, $0.PersistResponse>(
      '/flakkasdk.persistence.v1.PersistenceLocal/persist',
...
abstract class PersistenceLocalServiceBase extends $grpc.Service {
  $core.String get $name => 'flakkasdk.persistence.v1.PersistenceLocal';
