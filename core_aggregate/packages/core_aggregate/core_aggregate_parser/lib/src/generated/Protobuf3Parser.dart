...
import 'Protobuf3BaseVisitor.dart';
...
class Protobuf3Parser extends Parser {
  ...
  FieldLabelContext fieldLabel() {
    dynamic _localctx = FieldLabelContext(context, state);
  ...
  FieldNumberContext fieldNumber() {
    dynamic _localctx = FieldNumberContext(context, state);
  ...
  KeyTypeContext keyType() {
    dynamic _localctx = KeyTypeContext(context, state);
  ...
  Type_Context type_() {
    dynamic _localctx = Type_Context(context, state);
  ...
  TopLevelDefContext topLevelDef() {
    dynamic _localctx = TopLevelDefContext(context, state);
  ...
  EnumElementContext enumElement() {
    dynamic _localctx = EnumElementContext(context, state);
  ...
  MessageBodyContext messageBody() {
    dynamic _localctx = MessageBodyContext(context, state);
  ...
  ExtendDefContext extendDef() {
    dynamic _localctx = ExtendDefContext(context, state);
  ...
  BlockLitContext blockLit() {
    dynamic _localctx = BlockLitContext(context, state);
  ...
  MessageNameContext messageName() {
    dynamic _localctx = MessageNameContext(context, state);
  ...
  EnumNameContext enumName() {
    dynamic _localctx = EnumNameContext(context, state);
  ...
  ServiceNameContext serviceName() {
    dynamic _localctx = ServiceNameContext(context, state);
  ...
  MessageTypeContext messageType() {
    dynamic _localctx = MessageTypeContext(context, state);
  ...
  StrLitContext strLit() {
    dynamic _localctx = StrLitContext(context, state);
...
class ProtoContext extends ParserRuleContext {
  ...
  T? accept<T>(ParseTreeVisitor<T> visitor) {
    if (visitor is Protobuf3Visitor<T>) {
