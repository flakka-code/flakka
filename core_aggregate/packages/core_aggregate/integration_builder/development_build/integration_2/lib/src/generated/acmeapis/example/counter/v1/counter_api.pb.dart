...
class IncreaseValue extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'IncreaseValue', package: const $pb.PackageName(_omitMessageNames ? '' : 'acmeapis.example.counter.v1'), createEmptyInstance: create)
...
class DecreaseValue extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DecreaseValue', package: const $pb.PackageName(_omitMessageNames ? '' : 'acmeapis.example.counter.v1'), createEmptyInstance: create)
    ..a<$core.int>(2, _omitFieldNames ? '' : 'value', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
...
class ResetValue extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResetValue', package: const $pb.PackageName(_omitMessageNames ? '' : 'acmeapis.example.counter.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class GetCounter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetCounter', package: const $pb.PackageName(_omitMessageNames ? '' : 'acmeapis.example.counter.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class CurrentCounter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CurrentCounter', package: const $pb.PackageName(_omitMessageNames ? '' : 'acmeapis.example.counter.v1'), createEmptyInstance: create)
...
class CounterEntityApi extends $pb.GeneratedMessage {
  factory CounterEntityApi() => create();
  CounterEntityApi._() : super();
  factory CounterEntityApi.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory CounterEntityApi.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CounterEntityApi', package: const $pb.PackageName(_omitMessageNames ? '' : 'acmeapis.example.counter.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  CounterEntityApi clone() => CounterEntityApi()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CounterEntityApi copyWith(void Function(CounterEntityApi) updates) => super.copyWith((message) => updates(message as CounterEntityApi)) as CounterEntityApi;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static CounterEntityApi create() => CounterEntityApi._();
  CounterEntityApi createEmptyInstance() => create();
  static $pb.PbList<CounterEntityApi> createRepeated() => $pb.PbList<CounterEntityApi>();
  @$core.pragma('dart2js:noInline')
  static CounterEntityApi getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CounterEntityApi>(create);
  static CounterEntityApi? _defaultInstance;
}
