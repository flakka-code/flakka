...
class EntityApiTypedef extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EntityApiTypedef', package: const $pb.PackageName(_omitMessageNames ? '' : 'flakkaapi.v1'), createEmptyInstance: create)
    ...
    ..aQS(5, _omitFieldNames ? '' : 'instanceService')
  ...
  @$pb.TagNumber(5)
  $core.String get instanceService => $_getSZ(1);
  @$pb.TagNumber(5)
  set instanceService($core.String v) { $_setString(1, v); }
  @$pb.TagNumber(5)
  $core.bool hasInstanceService() => $_has(1);
  @$pb.TagNumber(5)
  void clearInstanceService() => clearField(5);
