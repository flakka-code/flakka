...
class IncreaseValue extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'IncreaseValue', package: const $pb.PackageName(_omitMessageNames ? '' : 'acmeapis.app1.counter.v1'), createEmptyInstance: create)
...
class DecreaseValue extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DecreaseValue', package: const $pb.PackageName(_omitMessageNames ? '' : 'acmeapis.app1.counter.v1'), createEmptyInstance: create)
    ..a<$core.int>(2, _omitFieldNames ? '' : 'value', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
...
class ResetValue extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResetValue', package: const $pb.PackageName(_omitMessageNames ? '' : 'acmeapis.app1.counter.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class GetCounter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetCounter', package: const $pb.PackageName(_omitMessageNames ? '' : 'acmeapis.app1.counter.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class CurrentCounter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CurrentCounter', package: const $pb.PackageName(_omitMessageNames ? '' : 'acmeapis.app1.counter.v1'), createEmptyInstance: create)
